...
filtered AS (
    SELECT
        ...
        --flags
        CASE WHEN arrival_revisedtime_utc IS NULL THEN 1 ELSE 0 END as is_missing_revised_time,
        CASE WHEN arrival_runwaytime_utc IS NULL THEN 1 ELSE 0 END as is_missing_runway_time,
